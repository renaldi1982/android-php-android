...
public class PHPBroadcastReceiver extends BroadcastReceiver {
    private static final String TAG = "EnzoneMockup: " + PHPBroadcastReceiver.class.getSimpleName();
    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        noOfTimes++;
        Toast.makeText(context, "PHP Broadcast Service Running for " + noOfTimes + " times", Toast.LENGTH_SHORT).show();
        AsyncHttpClient client = new AsyncHttpClient();
        RequestParams params = new RequestParams();
        // Checks if new records are inserted in Remote MySQL DB to proceed with Sync operation
        client.post("http://ray-renaldi.com:44400/services/getrowcount.php",params ,new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(String response) {
                ...
                try {
                    ...
                    System.out.println("EnZoneApp -> Unsync Row Count: " + obj.get("count"));
                    // If the count value is not zero, call MyService to display notification
                    Log.d("ENZONE_DEBUG",obj.toString());
            ...
            public void onFailure(int statusCode, Throwable error,
                ...
                if(statusCode == 404){
                    ...
                    Toast.makeText(context, "Error occured!, code: " + statusCode, Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
